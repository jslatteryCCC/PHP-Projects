<html>
  ...
  For example: Steven, Paul, and Jobs would display as "Steven P. Jobs".</i>
  <b>First Name</b><br>
  ...
  <p>2.
  <i>Split the following string on each dash - character. Display each word on its own line.</i>
