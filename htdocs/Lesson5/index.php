    ...
    <form action="investdetails.php" method="post">
        ...
        <select name="years" id="years">
            ...
            <option value="<?php echo $x ?>"
                <?php if ($x==5) echo " selected" ?>><?php echo $x ?>
            </option>
            <?php
            }
            ?>
        ...
        <h3>Optional: add an extra amount that will be added at the end of each year. 
            It will only be added if you select Yes.</h3>
        <p>
