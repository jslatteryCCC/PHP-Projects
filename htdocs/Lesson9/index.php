...
<p>
3. The following value contains a list of votes for favorite seasons including spring, summer, fall, and winter. 
Display a count of votes for each. If there are no votes, still display it with a count of 0.<br><br>
