...
if (isset($_GET['sortcourses'])) {
  //$default = $_GET['sortcourses'];
  $selector = $_GET['sortcourses'];
}
$sql = "SELECT * FROM courses ORDER BY $selector";
...
<td colspan="1">
  ...
  if (isset($_SESSION['update_count'])) {
    $update_message = $_SESSION['update_count'];
    echo "Rows affected: $update_message";
  }?>
  </p>
</td>
